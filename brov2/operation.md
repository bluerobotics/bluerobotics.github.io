...
To ensure that your LiPo batteries last as long as possible, it is important to not discharge the battery below 12.0 volts.  

A nominal 14.8 volt (a 4s pack) LiPo battery is fully charged when it reaches 16.8 volts. If you charge a 4S battery it beyond 16.8 volts, the battery may become damaged or catch fire. To safely charge a LiPo battery, you should charge with a LiPo-compatible charger. A LiPo-compatible charger will prevent over-charging; it will also balance the cells. A good rule of thumb is to charge your LiPo battery at less than "1C" or a 1 time its capacity. So, if you are using the 10,000mAh battery, you would want to charge at less than 10 amps.
...
3. Pump until the gauge reads 10 in. Hg vacuum.
4. Let the _BlueROV2_ and pump sit for 15 minutes.
5. If the gauge reads above 9 in. Hg vacuum after 15 minutes, your seals are acceptable.

If the gauge reads below 9 in. Hg vacuum after 15 minutes, you should check the following:
...
<i class="fa fa-exclamation-triangle fa-fw fa-2x text-warning"></i> Disarm the _BlueROV2_ prior to attempting to recovery it.
